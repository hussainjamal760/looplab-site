        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="we build the future of campus tech community">
                        {"we build the future of campus tech community".split('').map((char, index) => {
